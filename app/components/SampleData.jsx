          ...
          <StepBlock
            ...
            stepDesc={
              <>
                <ul>
                  <li>
                    The first step is to import essential Python libraries for
                ...
                <>
                  <ul>
                    <li>
                      ...
                      using <span className="codespan">pd.read_csv()</span>.
                      (Other options:{" "}
                      <span className="codespan">pd.read_excel()</span>,{" "}
                      <span className="codespan">pd.read_json()</span>)
                    </li>
                    <li>
                      Check the data types of each column to understand how the
                      data is represented (e.g., numeric, object, datetime).
                    </li>
                  </ul>
                </>
              </>
...
dataset.dtypes`}
          ...
          <Substep
            substepDesc={
              <>
                <ul>
                  <li>
                    <span className="codespan">dataset.shape</span> returns
          ...
          <Substep
            ...
            substepOutputDesc={
              <>
                <p>
                  There are missing values in the dataset which needs to be
                  handled through appropriate data cleaning or imputation
                  techniques
                </p>
                <ul>
                  <li>
          ...
          <StepBlock
            ...
            stepDesc={
              <>
                <ul>
                  <li>
                    Missing values in the Age, Cabin, and Fare columns are
                    handled using the{" "}
                    <span className="codespan">SimpleImputer</span>.
                  </li>
                  <li>
                    The imputer fills missing values with the most frequent
          ...
          <StepBlock
            ...
            stepDesc={
              <>
                <ul>
                  <li>
                    We will generate box plots for selected numerical features
                    to help detect <strong>outliers</strong> and understand
                    their distributions.
                  </li>
                </ul>
              </>
...
plt.show()`}
            stepOutput={
              <>
                <Image src="/assets/output/boxplot.png" className="boxplotImage" width={440} height={440} alt='boxplot'/>
              </>
            }
            stepOutputDesc={
              <>
                ...
                <ul>
                  ...
                  <li>
                    Most passengers had no siblings/spouses aboard. Some
                    outliers with upto 8 siblings/spouses
                  </li>
                  <li>
                    Again, most had no parents/children aboard. Outliers had up
                    to 9 family members.
                  </li>
                </ul>
                <p>
                  In our case outliers are genuine and meaningful, therefore we
          ...
          <StepBlock
            ...
            stepDesc={
              <>
                <ul>
                  <li>
                    The heatmap is a visual representation of the correlation
                    matrix for all numeric features in the dataset.
                  </li>
                  <li>
                    Used to find strong predictors for the target variable{" "}
                  </li>
                  <li>
                    Used to detect multicollinearity, which can affect models
...
plt.show()`}
            stepOutput={
              <>
                <Image src="/assets/output/heatmap.png" className="heatmapImage" width={420} height={300} alt='boxplot'/>
              </>
            }
            stepOutputDesc={
              <>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    correlation — lower class (3rd class) had lower survival
                    rates.
                  </li>
                  <li>
                    <strong>PassengerId correlations - ~0</strong>, No
                    meaningful correlation with any other variable — as
                    expected.
                  </li>
                </ul>
              </>
            ...
            substepDesc={
              <>
                <ul>
                  ...
                  <li>
                    <span className="codespan">.corr()</span> by default
